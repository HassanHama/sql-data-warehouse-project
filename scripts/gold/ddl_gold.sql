...
===============================================================================
Script Purpose:
    This script creates the final business-ready views in the 'gold' schema.
    It implements a Star Schema design:
...
WHERE
    pn.prd_end_dt IS NULL; -- Filter out historical product versions
...
SELECT
    ...
    pr.product_key  AS product_key,  -- Connects to dim_products
    cu.customer_key AS customer_key, -- Connects to dim_customers
